...
/// Dark theme configuration for CraftConnect app
/// Provides a modern, eye-friendly dark theme with proper contrast ratios
class DarkTheme {
  static const Color _primaryColor = Color(
    0xFF4DB6AC,
  ); // Lighter teal for dark mode
  static const Color _primaryVariant = Color(0xFF26A69A); // Medium teal
  ...
  static const Color _surfaceColor = Color(0xFF1E1E1E); // Elevated surface
